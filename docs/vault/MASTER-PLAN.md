...
**Próxima sesión sugerida:** Sprint 16 (3 parsers más siguiendo patrón Sprint 15: BrainWave + Philips NightOne + ResMed Diag, estimado ~3-4 h) o saltar a Sprint 2.B + 9-supabase (backend SomnoSalud webapp).
