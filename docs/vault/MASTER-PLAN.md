...
**Próxima sesión sugerida:** Sprint 2.B + 9-supabase (auth + RLS + migrar sessionStorage → DB con SleepData completo desde inicio) o Sprint 3 Deploy Vercel preview corto (~2 h) para que Pablo vea flow completo antes de meter persistencia.
