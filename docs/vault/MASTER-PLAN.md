...
**Próxima sesión sugerida:** Sprint 7 — Cuestionarios (ISI + STOP-BANG + PHQ-9 + GAD-7 + DASS-21 + sleep + lab + genetics) + Capa 4 (safety rules SAFE-010..040 enforcement). Estimado 5-6h.
