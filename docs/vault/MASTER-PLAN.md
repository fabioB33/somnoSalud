...
**Próxima sesión sugerida:** Sprint 7.B — PHQ-9 (con detección ítem 9 ideación suicida + recurso emergencia visible) + GAD-7 + DASS-21 + sleep diary + lab opcional + genetics opcional. Estimado 3-4h.
