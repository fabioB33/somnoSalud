...
**Próxima acción inmediata:** Mensaje a Jorge con resumen del Sprint 20 research + recomendación + las 7 preguntas pendientes para signoff. Bloqueante hasta respuesta. Mientras tanto: **Sprint Resend SMTP custom** (~2h, requires DNS access del dominio `somnosalud.com.ar`) destrabaría rate limit + sender profesional, o **Sprint 3.B Conversor PSG a Vercel separado** (~2h, requires smoke Pablo con PDFs reales).
