...
- 📚 **Sprint 5.5 in-progress (2026-05-08):** documentación complementaria del Sprint 5 en el Vault. 7 docs: 3 ADRs (stack frontend + workspace deps + compliance gates) + 1 convenciones frontend + 1 stack inventory + 2 updates (overview.md + README webapp-somnosalud). Detalle: [[sprints/sprint-5-5-documentacion-vault/SPRINT-5-5-DOCUMENTACION-VAULT]].
