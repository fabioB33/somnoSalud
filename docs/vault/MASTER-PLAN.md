...
**Próxima sesión sugerida:** smoke visual humano del Sprint 8.5 (Fabio verifica visualmente la UX nueva) → si OK, Sprint 8.6 (welcome expandida + FAQ + /about + /privacidad + /404) o Sprint 9+ Supabase (requiere Sprint 2.B Fabio).
