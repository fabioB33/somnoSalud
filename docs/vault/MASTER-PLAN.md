...
**Próxima sesión sugerida:** Sprint 2.B + 9 Supabase (auth + RLS + migrar sessionStorage → DB) o Sprint 3 Deploy Vercel preview corto (~2 h) para que Pablo vea flow completo antes de meter persistencia.
