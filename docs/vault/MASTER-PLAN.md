...
- 🚀 **Sprint 7.B in-progress (2026-05-09):** PHQ-9 (con detección live ítem 9 ideación suicida → Alert destructive + recurso emergencia 0800-999-0091 visible siempre, Decisión E3) + GAD-7 + DASS-21 (21 items con separators por subscale depression/anxiety/stress) + sleep diary form custom + lab opcional (7 parámetros con skip) + genetics opcional (5 variantes con skip) + placeholder `/eval/results`. Detalle: [[sprints/sprint-7-b-mental-health-sleep-lab-genetics/SPRINT-7-B-MENTAL-HEALTH-SLEEP-LAB-GENETICS]].

**Próxima sesión sugerida:** continuar Sprint 7.B → Sprint 8 (`/eval/results` con scoring real + recomendaciones + risk-integrator + phenotype, Capa 5 ADR-003).
