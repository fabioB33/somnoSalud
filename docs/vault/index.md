...
- [[sprints/sprint-8-5-ux-cuestionario/SPRINT-8-5-UX-CUESTIONARIO]] — Sprint 8.5 UX polish del `<QuestionnaireForm>` post-feedback: pills horizontales (no stack vertical), number badge con tick, progress sticky interno, smooth scroll al siguiente item, separators DASS-21 "Parte 1/2/3 de 3". Sin cambios lógica clínica. Status: in-progress.
