...
- [[sprints/sprint-13-e2e-playwright/SPRINT-13-E2E-PLAYWRIGHT]] — Sprint 13 tests E2E Playwright robustos del flow client-side. Setup @playwright/test + Chromium + webServer auto-launch + helpers reusables. 9 tests críticos cubren middleware Capa 1, edad Capa 3, safety SAFE-040 restrict + acknowledge flow, PHQ-9 ítem 9 detection, lab/genetics skip, results redirect, Reset Dialog, 404 custom. Status: in-progress.
