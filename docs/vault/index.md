...
- [[sprints/sprint-6-compliance-gates/SPRINT-6-COMPLIANCE-GATES]] — Sprint 6 implementa capas 1-3 de ADR-003 (middleware + DisclaimerBanner layout + verificación edad <18) + pantallas P0 (/disclaimer, /terms, /eval/profile, /eval/menor-no-permitido) + estado client-side (sessionStorage + cookie consent). Status: in-progress.
