...
- [[sprints/sprint-7-a-cuestionarios-safety/SPRINT-7-A-CUESTIONARIOS-SAFETY]] — Sprint 7.A implementa Capa 4 ADR-003 (`/eval/safety` con `evaluateAllSafetyRules` + bloqueo hard / restrict warning) + componente genérico `<QuestionnaireForm>` reutilizable + 3 cuestionarios (ISI 7×5niveles, ESS 8×4niveles, STOP-BANG 5manual+3auto). Status: in-progress.
